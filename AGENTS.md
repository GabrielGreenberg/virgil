...
Each sub-doc begins with `<!-- last-verified: beedb319 2026-09-26 -->`. If the hash is far behind `HEAD` and something feels stale, verify against the current code before relying on the doc.
