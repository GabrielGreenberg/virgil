...
Each sub-doc begins with `<!-- last-verified: 3b09f304 2026-09-15 -->`. If the hash is far behind `HEAD` and something feels stale, verify against the current code before relying on the doc.
