...
- **F#9** — [\"Open in Virgil tab\" button for library papers (list column + paper header)](#f9--open-in-virgil-tab-button-for-library-papers-list-column--paper-header) · `little` · **◑ PARTIAL (Phase 2)** — list column LANDED; the header-button half merges into F#11
