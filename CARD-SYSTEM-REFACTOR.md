...
### Session 13 — A4 keystone (BATCH-1) + AF-follow MERGED to main (2026-06-09)
...
- **Next: A1 gardening (the last BATCH-0 chip; incl. the ratified toolbar KILL)** — now unblocked (AF-follow landed the stack-path deletion gate) → then BATCH 2 (A3 ∥ A2-rest ∥ A9) → BATCH 3 (A5 ∥ A6 ∥ A10-rest).
...
| A1-impl | Gardening + ratified toolbar KILL (minus `popCardAtAnchor`→A3). Stack-path deletion now DONE by AF-follow. | 3 | impl | planned (BATCH 0 — **unblocked**) | — | A0 · AF · AF-follow |
