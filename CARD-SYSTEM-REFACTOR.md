...
### Session 13 — A4 keystone (BATCH-1) MERGED to main (2026-06-09)
- **A4-impl ✅ merged to `main`** (`90c050e`, `--no-ff`; main now 10 ahead of origin, **not pushed**). The selection ⟂ expansion split (N1) is **complete and landed** — Commits A–H, each tsc + tests green; final post-merge state **tsc clean, 577 tests (55 files)**.
...
- **Next: finish BATCH 0 — A1 gardening (incl. the ratified toolbar KILL) + AF-follow (`snapshotForStack`, must precede A1's legacy-stack-path deletion)** → then BATCH 2 (A3 ∥ A2-rest ∥ A9) → BATCH 3 (A5 ∥ A6 ∥ A10-rest).
