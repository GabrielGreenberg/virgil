...
\begin{itemize}
  ...
  \includegraphics[width=0.35\textwidth]{figures/sample-png} %!v:gx01
\end{itemize} %!v:55a8
...
\begin{figure}[ht]
  ...
  \caption{A schematic of a page with body text (light) and apparatus band (blue).}
  \label{fig:bands}
\end{figure}
...
\includegraphics[width=0.45\textwidth]{figures/sample-pdf}
...
\vxid{xi01}\a A medieval cleric correcting a copyist's error in a margin: a single inserted word, in a different hand, with a caret showing where it belongs.
\vxid{xi02}\b A Renaissance humanist marking up a printed edition: dense Latin commentary in a tiny hand, organized around the printed catchwords.
\vxid{xi03}\c Coleridge writing what amounts to a parallel essay in the margins of a borrowed copy of Kant.
\vxid{xi04}\d A twenty-first-century reader of a PDF dropping a colored highlight and a sticky note --- and below it, the diagram itself:

\includegraphics[width=0.4\textwidth]{figures/sample-pdf} %!v:gx02
\xe
...
Marginalia rarely sit politely within a single paragraph. \vlid{ab12}A reader who underlines a phrase often goes on to bracket the surrounding argument, dragging the line of attention through a paragraph break and into the next thought. %!v:lr01

That second thought is where the gloss usually lives: not in the noun phrase the reader first noticed, but in the explanation that follows it, on the next line.\vlidend{ab12} %!v:lr02
