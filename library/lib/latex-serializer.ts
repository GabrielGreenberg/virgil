...
import type { VirgilSidecar } from "@library/lib/types";
import { generateNodeUuid } from "@library/lib/uuid";
import { richJsonToLatex, richJsonToPlainText, normalizeRichContent } from "@library/lib/footnote-content";

// Inlined from /Users/gabriel/Programming/virgil/src/lib/marginalia.ts so we
// don't have to drag in marginalia code virgil-library doesn't use.
const ANCHORABLE_NODES = new Set([
  "paragraph",
  "heading",
  "bulletList",
  "orderedList",
