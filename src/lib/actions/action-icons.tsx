...
> = {
  ...
  "suggest-edit": { label: "Suggest edit", letter: "E", icon: <IconRevisions size={16} /> },
  cutter: { label: "Suggest cut", letter: "X", icon: <IconCutter size={16} /> },
  report: { label: "Report", letter: "R", icon: <IconReports size={16} /> },
