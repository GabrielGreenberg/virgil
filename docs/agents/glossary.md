...
| **EntityKind** | Linking-vocabulary subset of `CardKind`: `note \| cut \| revision \| todo \| archive \| report \| report-request \| footnote \| citation`. Used by hover/selection plumbing | [src/links/_shared/entity-hover.ts](../../src/links/_shared/entity-hover.ts) |
